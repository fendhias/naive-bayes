            ...
            <div class="col-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row border-bottom" style="padding-bottom: 20px">
                    <div class="col-md-10">
                      <h3>Daftar Tweet Training Netral</h3>
                    </div>
                    <div class="col-md-2">
                  ...
                  <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      ...
                      <div class="ticket-details col-md-11">
                        ...
                        <p class="text">Nulla quis lorem ut libero malesuada feugiat. Proin eget tortor risus. Lorem ipsum dolor sit amet Nulla quis lorem ut libero malesuada feugiat. Proin eget tortor risus. Lorem ipsum dolor sit amet.</p>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row border-bottom" style="padding-bottom: 20px">
                    <div class="col-md-10">
                      <h3>Daftar Tweet Training Positif</h3>
                    </div>
                    <div class="col-md-2">
                      <button type="button" class="btn btn-outline-danger btn-sm">
                        <i class="mdi mdi-delete"></i>Bersihkan</button>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row border-bottom" style="padding-bottom: 20px">
                    <div class="col-md-10">
                      <h3>Daftar Tweet Training Negatif</h3>
                    </div>
                    <div class="col-md-2">
                      <button type="button" class="btn btn-outline-danger btn-sm">
                        <i class="mdi mdi-delete"></i>Bersihkan</button>
